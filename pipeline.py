#!/usr/bin/env python3
"""
NYC Congestion Pricing Audit 2025 - Main Pipeline
Execute with: python pipeline.py
"""
...
def _configure_console_utf8() -> None:
    """
    Prevent UnicodeEncodeError on Windows consoles (cp1252/cp437) when printing emojis.
    Safe no-op on environments that don't support reconfigure().
    """
    try:
        import sys
